...
void fullFlow_MT() {
    ...
    Image* bwImage0 = getBWImage_MT(INPUT_FILE_0, OUTPUT_FILE_0_BW, OUTPUT_FILE_PROFILE_FILTERED_0);
    Image* bwImage1= getBWImage_MT(INPUT_FILE_1, OUTPUT_FILE_1_BW, OUTPUT_FILE_PROFILE_FILTERED_1);
